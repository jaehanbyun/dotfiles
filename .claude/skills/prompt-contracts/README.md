...
Medium 아티클 "I Stopped Vibe Coding and Started Prompt Contracts"에서 영감을 받아 2026-02-18 Obsidian Vault 프로젝트에서 생성되었습니다. 모호한 프롬프트로 인해 작업 시간의 30%를 되돌리기에 소비하는 "바이브 코딩"을 방지하기 위해, Goal/Constraints/Output Format/Failure Conditions 4요소 구조를 brainstorming/writing-plans 스킬에 통합하여 명확한 명세 작성을 강제합니다.
