...
1. Read 도구로 `~/Documents/Obsidian Vault/scripts/claude-release-tracker-state.json` 읽기
...
2. 대상 파일 경로 결정: `~/Documents/Obsidian Vault/001-INBOX/claude-code-releases-YYYY-MM.md`
